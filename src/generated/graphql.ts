...
export type GetAdjacentPostsQuery = { __typename?: 'Query', next: Array<{ __typename?: 'Post', title: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string } }>, previous: Array<{ __typename?: 'Post', title: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string } }> };
...
export type GetCommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', name: string, createdAt: any, comment: string }> };

export type GetFeaturedPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFeaturedPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, slug: string, createdAt: any, author?: { __typename?: 'Author', name: string, photo?: { __typename?: 'Asset', url: string } | null } | null, featuredImage: { __typename?: 'Asset', url: string } }> };
...
export type GetRecentPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string } }> };
...
export const GetCommentsDocument = gql`
  ...
  comments(where: {post: {slug: $slug}}) {
    ...
    `;
export const GetFeaturedPostsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetAdjacentPosts(variables: GetAdjacentPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetAdjacentPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAdjacentPostsQuery>(GetAdjacentPostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAdjacentPosts', 'query');
    },
    ...
    GetFeaturedPosts(variables?: GetFeaturedPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetFeaturedPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetFeaturedPostsQuery>(GetFeaturedPostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetFeaturedPosts', 'query');
    },
    ...
    GetSimilarPosts(variables: GetSimilarPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetSimilarPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSimilarPostsQuery>(GetSimilarPostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSimilarPosts', 'query');
    }
  };
}
